...
func (o *AppDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 406:
		result := NewAppDeleteNotAcceptable()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /api/v1/apps/{id}] appDelete", response, response.Code())
	}
}
...
func (o *AppDeleteOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteOK %s", 200, payload)
}
...
func (o *AppDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteBadRequest", 400)
}
...
func (o *AppDeleteUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteUnauthorized", 401)
}
...
func (o *AppDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteNotFound", 404)
}
...
func (o *AppDeleteNotAcceptable) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteNotAcceptable", 406)
}
...
func (o *AppDeleteNotAcceptable) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *AppDeleteInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/apps/{id}][%d] appDeleteInternalServerError", 500)
}
